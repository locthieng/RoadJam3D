...
//        {
//            // AppLovin SDK is initialized, start loading ads if user has consent
//            if (!GlobalController.Instance.ForTesting)
//            {
//                if (MaxSdk.HasUserConsent() || MaxSdk.GetSdkConfiguration().ConsentFlowUserGeography != MaxSdkBase.ConsentFlowUserGeography.Gdpr)
//                {
//                    //GoogleAdsController.Instance.Init();
//                    LoadAds();
//                }
//            }
//            AnalyticsController.Instance.Init();
//            AppsflyerController.Instance.Init();
...
//    public void ShowRewarded(UnityEvent callback, string placement)
//    {
//        AppsflyerController.Instance.LogEvent("af_rewarded_logicgame");
//        if (MaxSdk.IsRewardedAdReady(adUnitIdReward))
//        {
//            onRewarded = callback;
//            MaxSdk.ShowRewardedAd(adUnitIdReward, placement);
...
//        LoadInterstitial();
//        if (GoogleAdsController.Instance != null)
//        {
