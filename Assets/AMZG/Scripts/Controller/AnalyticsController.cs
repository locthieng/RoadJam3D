...
//    {
//        Debug.Log("Firebase Log Level Complete: level_" + level.ToString("000"));
//        FirebaseAnalytics.LogEvent(
//            "level_complete",
...
//        defaults.Add("collap_ads_levels", 3);
...
//        GoogleAdsController.Instance.CollapAdsLevels = (int)FirebaseRemoteConfig.DefaultInstance.GetValue("collap_ads_levels").LongValue;
