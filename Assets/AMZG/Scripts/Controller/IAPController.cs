...
//public class IAPEvent : UnityEvent<int> { };
...
//        "com.amzg.hypercore.noads",
//    };
//    //ID Item Apple Store
//    //To Do
//    public Dictionary<string, Product> ProductInfo { get; set; }

//    public Action purchaseSuccessNoAds;
...
//    public void BuyNoAds(Action onSuccess)
//    {
...
//                eventValues.Add(AFInAppEvents.CONTENT_ID, args.purchasedProduct.definition.id);
//                eventValues.Add(AFInAppEvents.PURCHASE, decimal.Multiply(args.purchasedProduct.metadata.localizedPrice, 0.63m).ToString());
//                eventValues.Add(AFInAppEvents.CURRENCY, args.purchasedProduct.metadata.isoCurrencyCode);
//                AppsflyerController.Instance.LogCustomEvent(AFInAppEvents.PURCHASE, eventValues);
//            }
//        }
