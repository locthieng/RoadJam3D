...
public class AssetControllerEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        GUIStyle colorfulStyle = new GUIStyle();
        colorfulStyle.richText = true;
        ...
        for (int i = 0; i < AssetController.ListSkinItemData.Count; i++)
        {
            ...
            GUILayout.BeginHorizontal();
            EditorGUILayout.LabelField("VIC: ");
            AssetController.ListSkinItemData[i].ValueInCoin = EditorGUILayout.IntField(AssetController.ListSkinItemData[i].ValueInCoin,
                new GUILayoutOption[] { GUILayout.Width(128), GUILayout.Height(20) });
            GUILayout.EndHorizontal();
