...
public class LevelEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        levelController.cellPrefab = (GameObject)EditorGUILayout.ObjectField("Cell Prefab", levelController.cellPrefab, typeof(GameObject), false);
        levelController.gridSize = EditorGUILayout.Vector2IntField("Grid Size", levelController.gridSize);
        levelController.cellSize = EditorGUILayout.FloatField("Cell Size", levelController.cellSize);
        levelController.gridAlignment = (GridAlignment)EditorGUILayout.EnumPopup("Alignment", levelController.gridAlignment);
        levelController.gridSpace = (GridSpace)EditorGUILayout.EnumPopup("Space", levelController.gridSpace);
        levelController.cellLayout = (CellLayout)EditorGUILayout.EnumPopup("Layout", levelController.cellLayout);
